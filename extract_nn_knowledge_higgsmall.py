"""
Extract NN knowledge for the higgsmall dataset.
...
import torch
import numpy as np
from utils import (prepare_data_higgsmall, train_nn, NN, print_clusters,
...
def main():
    """
    Loads or prepares the higgnsmall dataset, trains or loads the neural
    ...
    if os.path.exists(MODEL_PATH):
        ...
        model = train_nn(x_train, y_train, model_path=MODEL_PATH,
                         batch_size=512, epochs=2000, lr=0.003)
