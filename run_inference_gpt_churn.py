"""
Evaluates and compares churn predictions from a trained NN
...
import openai
from utils import prepare_data_churn, train_nn, truncate, NN, ensure_dir
from config import  PROMPT_TEMPLATE_RAW_CHURN as template_raw
from config import PROMPT_TEMPLATE_GUIDED_CHURN as template_guided
...
def print_scores(start_idx, end_idx, x_test, y_test, x_test_orig,
    ...
    Returns:
        ...
        the 'predictions/churn/' directory.
    """
    ...
    for sample_id in range(start_idx, end_idx):
        ...
        file_raw = f"predictions/churn/gpt-5_raw_churn{sample_id}.txt"
        ...
        gpt_output = response.choices[0].message.content.strip()
        file_guided = f"predictions/churn/gpt-5_guided_churn{sample_id}.txt"
...
if __name__ == "__main__":
    ...
    NPZ_PATH = "processed_data/churn_data_processed.npz"
    ...
    MODEL_PATH = "trained_nns/churn_nn.pth"
