"""
Evaluates and compares adult predictions from a trained NN
...
import openai
from utils import prepare_data_adult, train_nn, truncate, NN, ensure_dir
from config import  PROMPT_TEMPLATE_RAW_ADULT as template_raw
from config import PROMPT_TEMPLATE_GUIDED_ADULT as template_guided
...
def print_scores(start_idx, end_idx, x_test, y_test, x_test_orig,
    ...
    Returns:
        ...
        the 'predictions/adult/' directory.
    """
    ...
    for sample_id in range(start_idx, end_idx):
        ...
        file_raw = f"predictions/adult/gpt-5_raw_adult{sample_id}.txt"
        ...
        gpt_output = response.choices[0].message.content.strip()
        file_guided = f"predictions/adult/gpt-5_guided_adult{sample_id}.txt"
